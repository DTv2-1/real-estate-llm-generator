...
export const SparklesIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="m7.5 4.27 1.88 1.88M14.62 6.15l1.88-1.88M17.73 16.5l-1.88-1.88M6.15 9.38 4.27 7.5M17.73 7.5l-1.88 1.88M6.15 14.62l-1.88 1.88M9.38 17.73l-1.88-1.88M14.62 17.73l1.88 1.88" />
  </svg>
);
